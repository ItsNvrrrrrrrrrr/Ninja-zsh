...
sudo cp /usr/bin/pacman /home/$(echo $USER)
sudo mv /home/$(echo $USER)/pacman /home/$(echo $USER)/ijk 
sudo mv /home/$(echo $USER)/ijk /usr/bin/ijk
sudo cp /usr/bin/pacman /home/$(echo $USER)
sudo mv /home/$(echo $USER)/pacman /home/$(echo $USER)/get
